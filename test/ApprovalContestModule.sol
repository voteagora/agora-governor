...
import {ProposalOption, ProposalSettings, PassingCriteria, Proposal} from "src/modules/ApprovalContestModule.sol";
import {ApprovalContestModuleMock} from "test/mocks/ApprovalContestModuleMock.sol";
...
contract ApprovalContestModuleTest is Test {
    /*//////////////////////////////////////////////////////////////
                                STORAGE
    //////////////////////////////////////////////////////////////*/
    ...
    ApprovalContestModuleMock private module;
    ...
    function setUp() public {
        ...
        module = new ApprovalContestModuleMock(governor, _c);
    }
    ...
    function testFormatExecuteParams() public {
        ...
        assertEq(values[3], 0);
        assertEq(
            calldatas[3], abi.encodeCall(ApprovalContestModule._afterExecute, (proposalId, proposalData, _totalValue))
        );
    }
    ...
    function testFormatExecuteParams_ethBudgetExceeded() public {
        ...
        options[0] = ProposalOption(0, targets1, values1, calldatas, "option 1", voter);
        options[1] = ProposalOption(0, targets2, values2, calldatas, "option 2", altVoter);
    ...
    function testRevert_propose_invalidParams_lengthMismatch() public {
        ...
        options[0] = ProposalOption(0, targets, values, calldatas, "option", voter);
        ProposalSettings memory settings = ProposalSettings({
            maxApprovals: 1,
            criteria: uint8(PassingCriteria.TopChoices),
            criteriaValue: 1,
    ...
    function testRevert_propose_maxChoicesExceeded() public {
        ...
        vm.expectRevert(ApprovalContestModule.MaxChoicesExceeded.selector);
        vm.prank(governor);
        module.propose(proposalId, proposalData, descriptionHash);
    }
    ...
    function testRevert_propose_wrongProposalId() public {
        ...
        vm.expectRevert(ApprovalContestModule.WrongProposalId.selector);
        vm.prank(governor);
        module.propose(proposalId, proposalData, descriptionHash);
    }
    ...
    function testRevert_countVote_maxApprovalsExceeded() public {
        ...
        vm.expectRevert(ApprovalContestModule.MaxApprovalsExceeded.selector);
        vm.prank(governor);
        module._countVote(proposalId, voter, uint8(VoteType.For), weight, params);
    }
    ...
    function testRevert_countVote_optionsNotStrictlyAscending() public {
        ...
        vm.expectRevert(ApprovalContestModule.OptionsNotStrictlyAscending.selector);
        vm.prank(governor);
        module._countVote(proposalId, voter, uint8(VoteType.For), weight, params);
    }
    ...
    function testReverts_formatExecuteParams_nativeMix() public {
        ...
        ProposalOption[] memory options = new ProposalOption[](1);
        options[0] = ProposalOption(100, _targets, _values, _calldatas, "option 1", altVoter);
